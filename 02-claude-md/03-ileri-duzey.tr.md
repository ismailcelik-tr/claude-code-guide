...
→ Detaylar için: [settings.json](../03-hooks-otomasyon/01-settings-json.tr.md)
...
| Durum | Geri Dön |
|---|---|
| @import çalışmıyor | [Temel Yapı — Dosya Konumu](./01-temel-yapi.tr.md#dosya-konumu) |
| İzin verdiğim komut hâlâ soruluyor | [settings.json](../03-hooks-otomasyon/01-settings-json.tr.md) |
| Memory'e kaydettiğim şey unutuldu | [Bağlam Yönetimi](../05-prompt-stratejileri/02-baglam-yonetimi.tr.md) |

...
→ Şablon için: [Full-Stack CLAUDE.md](../02-claude-md/ornekler/fullstack.tr.md)
...
→ Detay: [Hooks & Otomasyon](../03-hooks-otomasyon/README.tr.md)
...
**[Senaryo 02 › Legacy Modernizasyon](./02-legacy-modernizasyon.tr.md)**
...
| Durum | Geri Dön |
|---|---|
| /plan komutu nasıl çalışır | [Plan Modu](../05-prompt-stratejileri/01-plan-modu.tr.md) |
| CLAUDE.md'yi nasıl yazacağımı bilemedim | [CLAUDE.md Temel Yapı](../02-claude-md/01-temel-yapi.tr.md) |
| Hook kurulumu başarısız | [settings.json](../03-hooks-otomasyon/01-settings-json.tr.md) |

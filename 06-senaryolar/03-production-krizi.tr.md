...
**[Senaryo 04 › Yeni Özellik Ekleme](./04-yeni-ozellik.tr.md)**
...
| Durum | Geri Dön |
|---|---|
| Log analizi nasıl yapılır | [Test & Debug — Log Analizi](../01-gelistirme-sureci/03-test-ve-debug.tr.md) |
| Deployment sürecinde sorun | [Deployment](../01-gelistirme-sureci/05-deployment.tr.md) |

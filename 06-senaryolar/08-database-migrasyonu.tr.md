...
**[Hızlı Başvuru Kartı](../cheatsheet.tr.md)**
...
| Durum | Geri Dön |
|---|---|
| Migration sonrası production patlıyor | [Production Krizi](./03-production-krizi.tr.md) |
| Test ortamında çalışıyor, prod'da çalışmıyor | [Deployment](../01-gelistirme-sureci/05-deployment.tr.md) |
| Migration'ı nasıl test edeceğimi bilemedim | [Test & Debug](../01-gelistirme-sureci/03-test-ve-debug.tr.md) |

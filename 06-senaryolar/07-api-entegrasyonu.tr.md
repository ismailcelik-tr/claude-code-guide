...
**[Senaryo 08 › Database Migrasyonu](./08-database-migrasyonu.tr.md)**
...
| Durum | Geri Dön |
|---|---|
| API entegrasyonu test edilemiyor | [Test & Debug](../01-gelistirme-sureci/03-test-ve-debug.tr.md) |
| Environment variable yönetimi | [Deployment — Ortam Değişkenleri](../01-gelistirme-sureci/05-deployment.tr.md) |
| CLAUDE.md'ye API bilgisi eklemek | [CLAUDE.md Proje Özeli](../02-claude-md/02-proje-ozeli.tr.md) |

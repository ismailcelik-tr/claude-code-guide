...
**[Senaryo 07 › API Entegrasyonu](./07-api-entegrasyonu.md)**
...
| Durum | Geri Dön |
|---|---|
| Güvenlik bulgusunu nasıl düzelteceğimi bilemedim | [Geliştirme](../01-gelistirme-sureci/02-gelistirme.md) |
| Test nasıl yazılır | [Test & Debug](../01-gelistirme-sureci/03-test-ve-debug.md) |
| Güvenlik bildirimi yapmak istiyorum | [SECURITY.md](../SECURITY.md) |

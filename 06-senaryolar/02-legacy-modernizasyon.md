...
**[Senaryo 03 › Production Krizi](./03-production-krizi.md)**
...
| Durum | Geri Dön |
|---|---|
| Explore subagent nasıl kullanılır | [Subagent Tipleri](../04-ajanlar/02-subagent-tipleri.md) |
| Testler nasıl üretilir | [Test & Debug](../01-gelistirme-sureci/03-test-ve-debug.md) |
| Claude dokunmaması gereken dosyayı değiştirdi | [CLAUDE.md Kısıtlar](../02-claude-md/02-proje-ozeli.md) |

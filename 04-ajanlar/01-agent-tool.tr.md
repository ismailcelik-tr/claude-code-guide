...
**[04 › Subagent Tipleri](./02-subagent-tipleri.tr.md)**
...
| Hangi subagent tipi kullanacağımı bilemedim | [Subagent Tipleri](./02-subagent-tipleri.tr.md) |
| Paralel çalıştırmak istiyorum | [Paralel Çalıştırma](./03-paralel-calistirma.tr.md) |

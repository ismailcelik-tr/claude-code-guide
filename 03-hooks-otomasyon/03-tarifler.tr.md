...
**[03 › Özel Komutlar](./04-ozel-komutlar.tr.md)**

Ya da doğrudan ajan kullanımına geç:

**[04 › Ajanlar](../04-ajanlar/README.tr.md)**
...
| Durum | Geri Dön |
|---|---|
| Tarif çalışmıyor | [settings.json Konumu](./01-settings-json.tr.md#konum-ve-format) |
| Hangi hook tipini kullanacağımı bilemedim | [Hook Tipleri](./02-hook-tipleri.tr.md) |
| exit 2 ne işe yarar | [PreToolUse Açıklaması](./02-hook-tipleri.tr.md) |

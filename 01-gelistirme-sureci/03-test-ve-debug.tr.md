...
**[01 › Code Review](./04-code-review.tr.md)**
...
| Durum | Geri Dön |
|---|---|
| Test üretildi ama çalışmıyor | [Geliştirme — Mevcut Kod Okuma](./02-gelistirme.tr.md) |
| Hata mesajı anlaşılmıyor | [Yaygın Hatalar](../05-prompt-stratejileri/03-yaygin-hatalar.tr.md) |
| Testler geçiyor ama production'da patlıyor | Bu sayfanın "Mock/Gerçek" bölümü |
| Code review'a geçmek istiyorum | [Code Review](./04-code-review.tr.md) |

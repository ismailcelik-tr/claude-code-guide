...
Büyük refactorlar için plan modunu kullan → [Planlama](./01-planlama.tr.md)
...
→ İzin yönetimi için: [settings.json](../03-hooks-otomasyon/01-settings-json.tr.md)
...
**[01 › Test & Debug](./03-test-ve-debug.tr.md)**
...
| Durum | Geri Dön |
|---|---|
| Claude çok fazla dosyayı değiştirdi | [Yaygın Hatalar](../05-prompt-stratejileri/03-yaygin-hatalar.tr.md) |
| Claude yanlış dosyayı düzenledi | [CLAUDE.md Proje Özeli](../02-claude-md/02-proje-ozeli.tr.md) |
| Yazdığım kod test edilmeden geçti | [Test & Debug](./03-test-ve-debug.tr.md) |
